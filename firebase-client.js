...
function normalizeVideoUrl(value) {
  ...
  const formerFirebaseVideo = url.match(/public%2Fvideos%2Fvideo0([1-5])\.mp4/i);
  const migratedVideoNumber = legacyCloudinaryVideo?.[1] || bundledVideo?.[1] || formerFirebaseVideo?.[1];
  return migratedVideoNumber ? googleDriveVideoUrl(migratedVideoNumber) : url;
}
